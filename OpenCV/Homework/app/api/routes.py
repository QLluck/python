...
async def api_process(
    ...
    segment_method: str = Form("dual"),          # 双路对比
    threshold_in_segment: str = Form("otsu"),
    morph_kernel_segment: int = Form(5),         # 更大形态核
    min_post_area: int = Form(30),               # 保留更多碎片
